...
*(Model: `outcome ~ minute + distance + pressure`, fit on `clean_passes.csv`.
Re-running `src/cognitive_model.R` reproduces the same statistical result,
rendered with `ggplot2` instead.)*
